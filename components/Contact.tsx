          ...
          <div className="flex w-full flex-col items-start justify-center pt-2">
            ...
            >
              <input
                ...
                className="w-full rounded-md border border-foreground/20 bg-background px-4 py-3 text-sm text-foreground shadow-sm transition-all placeholder:text-foreground/50 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                required
              />
              ...
              <textarea
                ...
                rows={4}
                className="w-full resize-none rounded-md border border-foreground/20 bg-background px-4 py-3 text-sm text-foreground shadow-sm transition-all placeholder:text-foreground/50 focus:border-primary focus:outline-none focus:ring-1 focus:ring-primary"
                required
              />
              ...
              <button
                ...
                className="mt-2 inline-flex items-center justify-center gap-2 self-start rounded-md bg-primary px-8 py-3 text-sm font-bold text-primary-foreground shadow-md transition-all hover:-translate-y-0.5 hover:bg-primary/90 hover:shadow-lg disabled:cursor-not-allowed disabled:opacity-60"
              >
...
function SocialLink({
  ...
  return (
    <a
      ...
      aria-label={label}
      className="flex h-12 w-12 items-center justify-center rounded-full bg-primary/80 text-primary-foreground shadow-sm transition-all duration-300 hover:scale-110 hover:bg-primary"
    >
      {children}
    </a>
  );
